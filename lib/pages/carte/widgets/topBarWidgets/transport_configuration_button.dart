import 'package:appli_r/pages/carte/widgets/topBarWidgets/TransportModeWidgets/transport_configuration_modal.dart';
...
class TransportConfigurationButton extends StatelessWidget {
  const TransportConfigurationButton({super.key});
      ...
      onPressed: () {
        showModalBottomSheet(
          ...
          builder: (BuildContext context) {
            return TransportConfigurationModal();
          },
        );
      },
