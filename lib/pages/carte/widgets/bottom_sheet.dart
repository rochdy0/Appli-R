...
class BottomSheetCarte extends StatefulWidget {
  ...
  const BottomSheetCarte({super.key, required this.onExpandChanged, required this.sheetExtentNotifier});
...
class _BottomSheetCarteState extends State<BottomSheetCarte> {
  ...
  onNotification: (notification) {
    ...
    if (extent != _lastExtent) {widget.sheetExtentNotifier.value = extent;}
    _lastExtent = extent;
      ...
      builder: (context, scrollController) {
        return Listener(
            onPointerUp: (_) {
              ...
              final nearest = _palierTailleSheet.reduce((a, b) =>
