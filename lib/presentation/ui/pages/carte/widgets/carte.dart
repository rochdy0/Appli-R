import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/bike/piste_cyclable_polyline.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/bike/voi_vehicules_marker.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/publicTransport/arrets_transport.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/direction_marker.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/gps_circle.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/gps_marker.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/gps_pulse_marker.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/carteWidgets/publicTransport/lignes_transport_polyline.dart';
import 'package:appli_r/presentation/ui/pages/carte/widgets/utils/load_map.dart';
...
class CarteWidget extends StatefulWidget {
  ...
  @override
  State<CarteWidget> createState() => _FlutterMapPmTilesPageState();
}
      ...
      builder: (context, snapshot) {
        ...
        // And many more recommended properties!
              ...
              ...switch (context.watch<TransportModeViewModel>().selectedMode) {
                ...
                TransportMode.bike => [
                  /*PisteCyclablePolyline()*/ VoiVehiculesMarker(),
                ],
                TransportMode.car => [],
              },
  ...
  "layers": [
    {
      "id": "background",
      "type": "background",
      "paint": {"background-color": "hsl(0, 7%, 97%)"},
    },
    {
    ...
    },
    {
      ...
      "filter": ["==", "class", "grass"],
      "paint": {"fill-color": "hsl(143, 61%, 79%)", "fill-opacity": 0.45},
    },
    {
      "id": "landcover_wood",
      "type": "fill",
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-color": "hsl(192, 72%, 75%)"},
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-color": "hsl(192, 72%, 75%)", "fill-opacity": 0.7},
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-color": "hsl(0, 7%, 97%)", "fill-opacity": 0.8},
    },
    {
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-antialias": true, "fill-color": "hsl(0, 7%, 97%)"},
    },
    {
      "id": "road_pier",
      "type": "line",
    ...
    },
    {
      ...
      "layout": {},
      "paint": {"fill-color": "hsl(0, 7%, 97%)", "fill-opacity": 0.5},
    },
    {
      "id": "road_path",
      "type": "line",
